// Ruta Segura Perú - Upload DIRCETUR Card Front Screen
...
export default function UploadDircerturFront() {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.description}>Take a photo of the FRONT of your DIRCETUR guide license card.</Text>

                <TouchableOpacity style={styles.uploadArea} onPress={() => setHasPhoto(true)}>
                    {hasPhoto ? (
                        <View style={styles.previewCard}><Text style={styles.previewEmoji}>🪪</Text><Text style={styles.previewText}>Card Front Captured</Text><View style={styles.checkBadge}><Text style={styles.checkText}>✓</Text></View></View>
                    ) : (
                        <>
                            <View style={styles.cardOutline}><Text style={styles.cardEmoji}>🪪</Text><Text style={styles.cardLabel}>FRENTE</Text></View>
                ...
                <View style={styles.tips}>
                    ...
                    <Text style={styles.tipItem}>📐 All corners visible</Text>
                    <Text style={styles.tipItem}>🔤 Text clearly readable</Text>
                </View>
            </View>

            <View style={styles.bottomBar}>
                <TouchableOpacity
                    style={[styles.continueButton, !hasPhoto && styles.buttonDisabled]}
                    onPress={() => router.push('/(guide)/verification/dircetur-back')}
                    disabled={!hasPhoto}
                >
...
const styles = StyleSheet.create({
    ...
    uploadArea: { backgroundColor: Colors.surfaceLight, borderRadius: 16, padding: Spacing.xl, alignItems: 'center', borderWidth: 2, borderStyle: 'dashed', borderColor: Colors.borderLight, marginBottom: Spacing.lg, minHeight: 200, justifyContent: 'center' },
    cardOutline: { width: 240, height: 150, borderRadius: 12, borderWidth: 2, borderColor: Colors.primary, borderStyle: 'dashed', alignItems: 'center', justifyContent: 'center', marginBottom: Spacing.sm },
    cardEmoji: { fontSize: 48 },
    cardLabel: { fontSize: 12, color: Colors.primary, fontWeight: 'bold', marginTop: 8 },
    ...
    tips: { backgroundColor: 'rgba(17, 82, 212, 0.05)', padding: Spacing.md, borderRadius: 12 },
    tipsTitle: { fontSize: 14, fontWeight: '600', color: Colors.textPrimary, marginBottom: Spacing.sm },
